...
#The following function is responsible for the main data-analysis:
...
#The remaining function produce plots based on the estimates stored in regpredictions:
